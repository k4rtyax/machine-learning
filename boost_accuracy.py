...
# Ini mengatasi masalah RECALL RENDAH yang menyebabkan akurasi ~77%

print('🌲 Training Random Forest (IMPROVED)...')
rf_model = RandomForestClassifier(
    n_estimators=300,           # Lebih banyak pohon
    max_depth=30,               # Batasi kedalaman agar tidak overfit
    min_samples_split=5,
    min_samples_leaf=2,
    class_weight='balanced',    # KUNCI! Beri bobot lebih ke kelas minoritas
    random_state=42,
    n_jobs=-1
)
...
# Hitung class weights untuk ANN
...
history = ann_model.fit(
    ...
    epochs=50,                    # Lebih banyak epoch
    batch_size=256,
    validation_split=0.2,
    class_weight=class_weights,   # KUNCI! Handle class imbalance
